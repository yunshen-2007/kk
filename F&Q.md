...
* **您必须通过Microsoft身份验证** 重启游戏或重新登录或开关飞行模式
* **没有网络/必须连接WiFi** 设置-档案-是用移动数据，开启后重新进服
* **无法连接世界/无效的IP地址** 检查IP端口是否正确，开关飞行模式或切换流量/WiFi，尝试试用其他线路进服，实在不行请重启路由器
* **并未获邀进入服务器** 请先正确绑定白名单
...
### 为什么有时候会集体掉线？
动态IP分配，基本上2-5天一次，等待1-5分钟即可。如果仍然进不去请开关飞行模式或重启游戏也可以选择使用备用线路。
